...
//    public static final Button A = register(new PlayerButton("A", "A", ButtonStyle.PRIMARY, p -> {}));
//    public static final Button B = register(new PlayerButton("B", "B", ButtonStyle.DANGER, p -> {}));
